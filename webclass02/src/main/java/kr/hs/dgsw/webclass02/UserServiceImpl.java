...
public class UserServiceImpl implements UserService{
    ...
    public UserServiceImpl(){
        ...
        userList.add(new User("user1","김가형","kimgahyung@dgsw.hs.kr")); // 유저 1 추가
        userList.add(new User("user2","아리아","aria@dgsw.hs.kr")); // 유저 2 추가
        userList.add(new User("user3","베로니카","veronica@dgsw.hs.kr")); // 유저 3 추가
    }
